...
public class LegoClient implements ServiceObserver {
        ...
        try {
            new Thread() {
                public void run() {                    
                    ...
                    LegoSet request = LegoSet.newBuilder()
                        .setName("CHIMA")
                        ...
                        .build();
                    logger.log (Level.INFO, "Number of bricks needed to build the folowing Lego Sets {0}", request);  

                    ConstructedLegoToy response = blockingStub.buildLego(request);
    ...
    public void getLegoPiece() throws InterruptedException {
        ...
        //ui.append(requestObserver.toString());
        ...
        logger.info("finished returning a stream of Lego Product Lines");
   }
